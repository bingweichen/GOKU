...
class Battery extends Component {
  ...
  wxpay() {
    wx.chooseWXPay({
      ...
      nonceStr: 'UFsSVgsTXz77VnpQ', // 支付签名随机串，不长于 32 位
      package: 'prepay_id=wx20170912170420eb006a8e670744861202', // 统一支付接口返回的prepay_id参数值，提交格式如：prepay_id=***）
      signType: 'MD5', // 签名方式，默认为'SHA1'，使用新版支付需传入'MD5'
      paySign: 'D60E5D7F83734565F2061492579E364C', // 支付签名
